...
public:
	...
	RoamingCamera(SceneManager* scene_manager, RenderWindow* render_window, Vector3 position, Vector3 lookat_position = Vector3(0, 0, 0));
	~RoamingCamera();
...
private:
	...
	SceneNode*	camera_node_;		// The scene node that holds the camera
